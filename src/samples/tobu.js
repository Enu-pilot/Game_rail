...
// 配線：配線略図.net（東武伊勢崎線・日光線・鬼怒川線）、駅の番線数：Wikipedia 各駅記事（docs/sample-stations.md）　キロ程：Wikipedia 各線の駅一覧
  ...
  lines: [
    {
      ...
      stations: [
        S('浅草', 0.0, 't', 55, 'tourist', { stubs: 4 }), S('とうきょうスカイツリー', 1.1, 's', 30, 'tourist'),
        S('曳舟', 2.4, 'p', 15, 'mixed'), S('東向島', 3.2, 's', 8), S('鐘ヶ淵', 4.2, 'p', 8), S('堀切', 5.3, 's', 4),
        ...
        S('北春日部', 36.8, 'p', 5), S('姫宮', 38.4, 's', 5), S('東武動物公園', 41.0, 'p', 15, 'mixed'),
      ],
    },
    {
      ...
      stations: [
        S('東武動物公園', 0.0), S('杉戸高野台', 3.2, 'p', 8), S('幸手', 5.8, 's', 8), S('南栗橋', 10.4, 'p', 6),
        S('栗橋', 13.9, 's', 5), S('新古河', 20.6, 's', 1), S('柳生', 23.6, 's', 0.5), S('板倉東洋大前', 25.6, 'p', 3, 'school'),
        S('藤岡', 29.5, 's', 1), S('静和', 37.3, 's', 0.5), S('新大平下', 40.1, 'p', 1), S('栃木', 44.9, 'pd', 6, 'mixed'),
        S('新栃木', 47.9, 'p', 3), S('合戦場', 50.0, 's', 1), S('家中', 52.4, 's', 1), S('東武金崎', 56.6, 'p', 1),
        ...
        S('上今市', 88.4, 's', 0.5), S('東武日光', 94.5, 't', 8, 'tourist', { stubs: 5 }),
      ],
    },
    {
      ...
      stations: [
        ...
        S('下今市', 0.0, 'pd', 1, 'tourist', { ra: true, tt: true }), S('大谷向', 0.8, 'pd', 0.3),
        S('大桑', 4.8, 'pd', 0.3), S('新高徳', 7.1, 'pd', 0.3), S('小佐越', 9.9, 'pd', 0.2),
        S('東武ワールドスクウェア', 10.6, 's', 1, 'tourist'), S('鬼怒川温泉', 12.4, 'p', 4, 'tourist', { ra: true, tt: true }),
        S('鬼怒川公園', 14.5, 'p', 1, 'tourist'), S('新藤原', 16.2, 'p', 0.5),
      ],
    },
  ],
  through: [

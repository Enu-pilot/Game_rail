...
// 配線：配線略図.net（東北・上越・北陸新幹線、田沢湖線・奥羽本線）、駅の番線数：Wikipedia 各駅記事（docs/sample-stations.md）　キロ程：Wikipedia 各線の駅一覧（実キロ）
  ...
  lines: [
    {
      ...
      stations: [
        S('東京', 0.0, 't', 200, 'business', { stubs: 4 }), S('上野', 3.6, 'p', 40, 'urban'), S('大宮', 31.3, 'p', 60, 'urban'),
        ...
        S('くりこま高原', 385.7, 's', 2), S('一ノ関', 406.3, 'p', 4), S('水沢江刺', 431.3, 's', 2),
        S('北上', 448.6, 'p', 3), S('新花巻', 463.1, 's', 2, 'tourist'), S('盛岡', 496.5, 'p', 20, 'urban'),
        S('いわて沼宮内', 527.6, 's', 1), S('二戸', 562.2, 's', 1), S('八戸', 593.1, 'p', 6),
        S('七戸十和田', 629.2, 's', 1), S('新青森', 674.9, 'p', 8),
      ],
    },
    {
    ...
    },
    {
      ...
      turns: { '長野': 175 },
      stations: [
        S('高崎', 0.0), S('安中榛名', 18.5, 's', 1), S('軽井沢', 41.8, 'p', 6, 'tourist'), S('佐久平', 59.4, 's', 3),
        S('上田', 84.2, 's', 4), S('長野', 117.4, 'p', 15, 'urban'), S('飯山', 147.3, 's', 1),
        S('上越妙高', 176.9, 'p', 2),
      ],
    },
    {
      ...
      turns: { '富山': 165, '金沢': 130 },
      stations: [
        S('上越妙高', 0.0), S('糸魚川', 37.0, 's', 1), S('黒部宇奈月温泉', 76.2, 's', 1, 'tourist'),
        S('富山', 110.0, 'p', 15, 'urban'), S('新高岡', 128.9, 's', 2), S('金沢', 168.6, 'p', 25, 'urban'),
        S('小松', 195.7, 's', 2), S('加賀温泉', 210.2, 'p', 2, 'tourist'), S('芦原温泉', 226.5, 's', 1, 'tourist'),
        S('福井', 244.5, 's', 6), S('越前たけふ', 263.5, 'p', 1), S('敦賀', 293.7, 'p', 3),
      ],
    },
    {
      ...
      stations: [
        S('新青森', 0.0), S('奥津軽いまべつ', 38.5, 'p', 0.2), S('木古内', 113.3, 'pu', 0.3),
        S('新函館北斗', 148.8, 's', 3, 'tourist'), S('新八雲', 203.0, 'p', 0.5), S('長万部', 235.9, 'p', 0.5),
    ...
    },
    {
      ...
      stations: [
        ...
        S('大曲', 75.6, 'p', 3, 'mixed', { dwell: 180 }), S('神宮寺', 81.6, 'pd', 0.2), S('刈和野', 89.2, 'pd', 0.3),
        S('峰吉川', 94.0, 'pd', 0.1), S('羽後境', 100.5, 'pd', 0.2), S('大張野', 108.6, 's', 0.1),
        S('和田', 114.0, 'pd', 0.2), S('四ツ小屋', 120.9, 'pd', 0.2), S('秋田', 127.3, 't', 15, 'urban', { stubs: 10 }),
      ],
    },
    {

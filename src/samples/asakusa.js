...
// 配線：配線略図.net（都営浅草線・京成押上線・京成本線・京急本線・空港線）　キロ程：Wikipedia 各線の駅一覧
  ...
  lines: [
    {
      ...
      stations: [
        S('西馬込', 0.0, 't', 15, 'residential', { stubs: 3 }), S('馬込', 1.2, 's', 15), S('中延', 2.1, 's', 15),
    ...
    },
    {
      ...
      stations: [
        S('泉岳寺', 0.0), S('品川', 1.2, 'p', 120, 'business'), S('北品川', 1.9, 's', 5), S('新馬場', 2.6, 's', 12),
        ...
        S('鶴見市場', 15.0, 's', 8), S('京急鶴見', 16.5, 'p', 15), S('花月総持寺', 17.3, 's', 8), S('生麦', 18.1, 's', 10),
        S('京急新子安', 19.5, 's', 5), S('子安', 20.5, 's', 4), S('神奈川新町', 21.2, 'p', 12), S('京急東神奈川', 21.7, 's', 8),
        ...
        S('上大岡', 32.0, 'p', 50, 'mixed'), S('屏風浦', 34.2, 's', 8), S('杉田', 35.5, 's', 12), S('京急富岡', 37.9, 'p', 10),
        S('能見台', 38.6, 's', 10), S('金沢文庫', 40.7, 'p', 25), S('金沢八景', 42.1, 'p', 25), S('追浜', 44.0, 's', 15),
        S('京急田浦', 45.7, 'p', 5), S('安針塚', 48.3, 's', 3), S('逸見', 49.3, 's', 4), S('汐入', 50.4, 's', 12),
        ...
        S('京急長沢', 62.0, 's', 4), S('津久井浜', 63.2, 's', 3), S('三浦海岸', 64.7, 'p', 6, 'tourist'),
    ...
    },
    {
      ...
      turns: { '糀谷': 10 },
      stations: [
        S('京急蒲田', 0.0), S('糀谷', 0.9, 's', 10), S('大鳥居', 1.9, 'p', 12), S('穴守稲荷', 2.6, 's', 5),
    ...
    },
    {
      ...
      stations: [
        ...
        S('京成小岩', 8.7, 's', 12), S('江戸川', 9.9, 's', 5), S('国府台', 10.6, 's', 6, 'school'), S('市川真間', 11.5, 's', 8),
        S('菅野', 12.4, 's', 4), S('京成八幡', 13.3, 'p', 20), S('鬼越', 14.3, 's', 5), S('京成中山', 15.0, 's', 4),
        S('東中山', 15.8, 'p', 6), S('京成西船', 16.4, 's', 8), S('海神', 17.8, 's', 4), S('京成船橋', 19.3, 's', 45, 'mixed'),
        S('大神宮下', 20.6, 's', 5), S('船橋競馬場', 21.4, 's', 12), S('谷津', 22.4, 's', 8), S('京成津田沼', 23.9, 'p', 20, 'mixed'),
        S('京成大久保', 26.3, 's', 15, 'school'), S('実籾', 28.2, 's', 10), S('八千代台', 30.8, 'p', 25), S('京成大和田', 32.9, 's', 8),
        S('勝田台', 34.5, 'p', 25), S('志津', 36.3, 's', 12), S('ユーカリが丘', 37.4, 'p', 15), S('京成臼井', 39.9, 's', 10),
        S('京成佐倉', 45.2, 'p', 10, 'mixed'), S('大佐倉', 47.2, 's', 1), S('京成酒々井', 49.2, 's', 3), S('宗吾参道', 51.2, 'p', 3),
        S('公津の杜', 52.8, 's', 6), S('京成成田', 55.4, 'p', 15, 'tourist'), S('空港第2ビル', 62.5, 's', 15, 'airport'),
        S('成田空港', 63.5, 't', 25, 'airport', { stubs: 2 }),
      ],
    },
    {
      ...
      stations: [
        ...
        S('千住大橋', 5.6, 's', 5), S('町屋', 7.2, 's', 12), S('新三河島', 8.1, 's', 3), S('日暮里', 9.4, 's', 50, 'mixed'),
        S('京成上野', 11.5, 't', 30, 'tourist', { stubs: 3 }),
      ],
    },
    {
      ...
      stations: [
        S('京成高砂', 0.0), S('東松戸', 7.5, 's', 8), S('新鎌ヶ谷', 12.7, 'p', 15), S('千葉ニュータウン中央', 23.8, 'p', 10),
        S('印旛日本医大', 32.3, 'p', 3), S('成田湯川', 40.7, 'p', 1), S('空港第2ビル（アクセス線）', 50.4, 's', 10, 'airport'),
        S('成田空港（アクセス線）', 51.4, 't', 15, 'airport', { stubs: 2 }),
      ],
    },
  ],
  through: [

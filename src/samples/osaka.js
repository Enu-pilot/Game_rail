...
// 配線：配線略図.net（大阪環状線・阪和線・関西本線）、駅の番線数：Wikipedia 各駅記事（docs/sample-stations.md）　キロ程：Wikipedia 各線の駅一覧
  ...
  lines: [
    {
      ...
      stations: [
        ...
        ['京橋', 6.5, 's', P(130, 'urban')],
        ['桜ノ宮', 8.3, 's', P(20, 'mixed')],
        ['天満', 9.1, 's', P(30, 'mixed')],
        ['大阪', 10.7, 's', P(260, 'business')],
        ['福島', 11.7, 's', P(30, 'business')],
        ['野田', 13.1, 's', P(20, 'mixed')],
        ['西九条', 14.3, 's', P(40, 'mixed')],
    ...
    },
    {
      ...
      stations: [
        ['天王寺', 0.0, 'p', P(40, 'urban')], ['東部市場前', 2.4, 's', P(10, 'mixed')], ['平野', 3.9, 'pd', P(12, 'residential')],
        ...
        ['加茂', 50.5, 't', P(5, 'residential', { stubs: 3 })],
      ],
    },
    {
      ...
      turns: { '安治川口': 180 },
      stations: [
        ['西九条', 0.0, 's', P(10, 'mixed')], ['安治川口', 2.4, 's', P(8, 'business')], ['ユニバーサルシティ', 3.2, 's', P(45, 'tourist')],
  ...
  services: [
    ...
    },
    {
      ...
      stops: {
        ...
        kanjo: ['天王寺', '寺田町', '桃谷', '鶴橋', '玉造', '森ノ宮', '大阪城公園', '京橋', '桜ノ宮', '天満', '大阪', '福島', '西九条', '弁天町', '新今宮', '天王寺'],
      },

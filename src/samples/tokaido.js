...
// 配線：配線略図.net（東海道・山陽・九州新幹線）　キロ程：Wikipedia 各線の駅一覧（実キロ）
  ...
  lines: [
    {
      ...
      stations: [
        TK('東京', 0.0, 't', 220, 'business', { stubs: 6 }), TK('品川', 6.8, 's', 80, 'business'),
    ...
    },
    {
      ...
      turns: { '熊本': 115, '新八代': 95 },
      stations: [
        TK('博多', 0.0), TK('新鳥栖', 26.3, 'p', 3), TK('久留米', 32.0, 's', 6), TK('筑後船小屋', 47.9, 'p', 2),
        TK('新大牟田', 59.7, 'p', 2), TK('新玉名', 76.3, 'p', 2), TK('熊本', 98.2, 'p', 20, 'urban'),
        TK('新八代', 130.0, 'p', 3), TK('新水俣', 172.8, 'p', 1), TK('出水', 188.8, 'p', 2),
        TK('川内', 221.5, 'p', 3), TK('鹿児島中央', 256.8, 't', 25, 'urban', { stubs: 4 }),
      ],
    },
  ],
  through: [

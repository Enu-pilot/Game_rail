...
// 配線：配線略図.net（南海本線・高野線）　キロ程：Wikipedia 各線の駅一覧
  ...
  lines: [
    {
      ...
      stations: [
        S('難波', 0.0, 't', 140, 'urban', { stubs: 4 }), S('新今宮', 1.4, 's', 40, 'mixed'), S('天下茶屋', 3.0, 'p', 25, 'mixed'),
        S('岸里玉出', 3.9, 's', 5), S('粉浜', 5.1, 's', 4), S('住吉大社', 5.7, 's', 6, 'tourist'), S('住ノ江', 6.7, 'p', 8),
        S('七道', 8.2, 's', 10), S('堺', 9.8, 'p', 25, 'mixed'), S('湊', 11.2, 's', 6), S('石津川', 12.7, 's', 5),
        S('諏訪ノ森', 13.8, 's', 4), S('浜寺公園', 14.8, 'p', 5), S('羽衣', 15.6, 'p', 12), S('高石', 17.3, 's', 6),
        S('北助松', 18.5, 's', 5), S('松ノ浜', 19.5, 's', 4), S('泉大津', 20.4, 'p', 12, 'mixed'), S('忠岡', 22.3, 's', 4),
        S('春木', 23.7, 'p', 6), S('和泉大宮', 25.0, 's', 4), S('岸和田', 26.0, 'p', 18, 'mixed'), S('蛸地蔵', 26.9, 's', 3),
        S('貝塚', 28.6, 'p', 10), S('二色浜', 30.4, 's', 4), S('鶴原', 31.3, 's', 3), S('井原里', 32.4, 's', 3),
        S('泉佐野', 34.0, 'p', 15, 'mixed'), S('羽倉崎', 36.1, 'p', 3), S('吉見ノ里', 37.4, 's', 2), S('岡田浦', 38.8, 's', 1),
        S('樽井', 40.6, 'p', 3), S('尾崎', 43.1, 'p', 4), S('鳥取ノ荘', 44.6, 's', 2), S('箱作', 46.6, 's', 3),
        S('淡輪', 50.2, 's', 1), S('みさき公園', 51.9, 'p', 2, 'tourist'), S('孝子', 56.3, 's', 0.2),
        S('和歌山大学前', 58.0, 'p', 5, 'school'), S('紀ノ川', 61.6, 's', 1), S('和歌山市', 64.2, 't', 15, 'urban', { stubs: 3 }),
      ],
    },
    {
    ...
    },
    {
      ...
      stations: [
        ...
        S('帝塚山', 5.0, 's', 5), S('住吉東', 5.9, 's', 5), S('沢ノ町', 6.8, 's', 4), S('我孫子前', 7.4, 's', 5),
        S('浅香山', 8.7, 's', 6), S('堺東', 10.3, 'p', 45, 'mixed'), S('三国ヶ丘', 11.8, 's', 25), S('百舌鳥八幡', 12.7, 's', 4),
        S('中百舌鳥', 13.4, 'p', 25, 'mixed'), S('白鷺', 14.4, 's', 8), S('初芝', 15.9, 's', 12), S('萩原天神', 16.8, 's', 8),
        S('北野田', 18.6, 'p', 18), S('狭山', 19.5, 's', 5), S('大阪狭山市', 21.1, 's', 8), S('金剛', 22.2, 'p', 22),
        S('滝谷', 23.9, 's', 6), S('千代田', 25.2, 'p', 8), S('河内長野', 27.3, 'p', 20, 'mixed'), S('三日市町', 29.0, 's', 8),
        S('美加の台', 30.6, 's', 5), S('千早口', 32.5, 's', 1), S('天見', 34.2, 's', 1), S('紀見峠', 37.9, 'p', 1),
        S('林間田園都市', 39.2, 'p', 10), S('御幸辻', 41.2, 's', 3), S('橋本', 44.0, 'p', 10, 'mixed'),
        S('紀伊清水', 47.1, 'pd', 0.5), S('学文路', 49.7, 'pd', 0.5), S('九度山', 51.5, 'pd', 1, 'tourist'),
        S('高野下', 53.5, 'pd', 0.5), S('下古沢', 55.2, 's', 0.2), S('上古沢', 56.9, 'pd', 0.2),
        S('紀伊細川', 59.9, 'pd', 0.1), S('紀伊神谷', 62.3, 's', 0.1), S('極楽橋', 63.8, 't', 4, 'tourist', { stubs: 2 }),
      ],
    },
  ],
  through: [

...
export const OBJECT_GROUPS = [
  ...
  },
  {
    id: 'signal', name: '分岐器・信号', items: [
      ...
      { id: 'signal_block',   name: '閉塞信号機',        w: 5,  h: 5,  color: '#ffb020', shape: 'signal', lamps: 3 },
      { id: 'signal_shunt',   name: '入換信号機',        w: 5,  h: 5,  color: '#8fe06a', shape: 'signal', lamps: 2 },
      { id: 'shunt_marker',   name: '入換標識',          w: 5,  h: 5,  color: '#8fe06a', shape: 'marker' },
